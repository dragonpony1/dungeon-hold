...
// crystal always stands at world (0,0), so the fallback lands somewhere sane with no per-map wiring). Visual only
// for now, deliberately -- no E-prompt, no interaction, no hideout behind it yet. That's its own separate piece of
// work, still in progress elsewhere; this module only makes the portal itself show up where it'll eventually lead.
(function(){
