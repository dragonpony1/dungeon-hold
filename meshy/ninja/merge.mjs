...
await page.goto("http://127.0.0.1:8794/merge.html"); await page.waitForFunction(()=>window.build,null,{timeout:60000});
const out=await page.evaluate(()=>window.build());
fs.writeFileSync("ninja.glb",Buffer.from(out.b64,"base64")); delete out.b64;
console.log(JSON.stringify(out,null,2), "errors:", errs.length?errs.join(" | "):"none");
