// node merge.mjs — merges rig.glb + clips into trollboss.glb (see merge.html)
...
if(out.b64){ fs.writeFileSync("trollboss.glb",Buffer.from(out.b64,"base64")); delete out.b64; }
