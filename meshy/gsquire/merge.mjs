...
await page.goto("http://127.0.0.1:8798/merge.html"); await page.waitForFunction(()=>window.build);
const out=await page.evaluate(()=>window.build());
fs.writeFileSync("gsquire.glb",Buffer.from(out.b64,"base64")); delete out.b64;
