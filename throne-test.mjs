...
check("hero spawns on the throne platform eight up; windows and rails built; tavern re-homed with 5 stations; wbase 7",r.heroY>=7.9&&r.windows>=6&&r.stations===5&&r.wbase===7&&/MAP 2 OF 5/.test(r.line),JSON.stringify({heroY:r.heroY,windows:r.windows,stations:r.stations}));
