...
check("the twelve defenses on the hotbar, in order (seven towers, the snare, four halos)",n0.slots.join("|")==="Ballista|Acorn Cannon|Turnip Trebuchet|Mushroom Ring|Bramble Hedge|Rune Totem|Frost Spire|Snare Tower|Storm Halo|Venom Halo|Ember Halo|Dazzling Halo",n0.slots.join("|"));
